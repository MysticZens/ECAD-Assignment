...
define('GUSER', 'giftownsingapore@gmail.com'); // GMail username to access SMTP mail server
define('GPWD', 'scmr bqky guzy qhzl'); // GMail app password to access SMTP mail server
