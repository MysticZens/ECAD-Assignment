    ...
    <form name="frmSearch" method="get" action="">
        ...
        <div class="mb-3 row"> <!-- 5th row -->
            <div class="col-sm-12 text-center">
                <button type="submit" class="btn btn-primary submitbutton">Search</button>
            </div>
        </div> <!-- End of 5th row -->
    </form>
</div>
...
// PRODUCT TITLE/DESC + PRICE RANGE
    ...
    $keywords3 = intval($_GET["keywords3"]);  // Convert to integer
    $result3 = $_GET["keywords3"];
    echo "Search results for Title/Description : <b>" . $result . "</b>| Maximum Price : $<b>" . $result2 ."</b>| Minimum Price : $<b>" . $result3 . "</b></br>";
...
if ((isset($_GET["keywords1"]) && trim($_GET['keywords1']) != "") &
    ...
    $keywords3 = intval($_GET["keywords3"]);  // Convert to integer
    $result3 = $_GET["keywords3"];
    echo "Search results for Occasion : <b>" . $result1 ."</b>| Maximum Price : $<b>" . $result2 .
    "</b>| Minimum Price : $<b>" . $result3 . "</br>";
...
// RANGE ONLY
    ...
    $keywords3 = intval($_GET["keywords3"]);  // Convert to integer
    $result3 = $_GET["keywords3"];
    echo "Search results for Maximum Price : $<b>" . $result3 . "</b>| Minimum Price : $<b>" . $result2 . "</b></br>";
